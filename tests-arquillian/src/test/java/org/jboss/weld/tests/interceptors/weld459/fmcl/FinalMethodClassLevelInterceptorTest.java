...
public class FinalMethodClassLevelInterceptorTest {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(FinalMethodClassLevelInterceptorTest.class))
                .intercept(MissileInterceptor.class)
                .addPackage(FinalMethodClassLevelInterceptorTest.class.getPackage());
    }
