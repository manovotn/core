    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap
                .create(WebArchive.class,
                        Utils.getDeploymentNameAsHash(ExtensionProvidedBeanDefiningAnnotationTest.class,
                                Utils.ARCHIVE_TYPE.WAR))
                .addClasses(MainBean.class, ClassForInject.class)
                .addAsLibraries(
                        ShrinkWrap.create(JavaArchive.class)
                                .addClasses(ScopeRegistryExtension.class, CustomAnnotation.class, CustomContext.class)
