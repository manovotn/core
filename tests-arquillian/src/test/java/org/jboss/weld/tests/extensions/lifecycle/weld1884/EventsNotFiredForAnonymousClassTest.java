...
public class EventsNotFiredForAnonymousClassTest {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(EventsNotFiredForAnonymousClassTest.class))
                .addClasses(BeanWithAnonymousClasses.class, TestExtension.class)
