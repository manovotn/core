...
public class UnwrappingUncheckedExceptionTest {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(UnwrappingUncheckedExceptionTest.class))
    ...
    public void assertExceptionIsUnwrapped(Simple bean) {
        assertThrows(UnsupportedOperationException.class, () -> bean.speak());
    }
}
