...
public class InterceptorBindingOverridingTest {
    ...
    public void testInterceptorBindingOverriden() {
        assertEquals(-4, pony.getAge()); // getAge() return 3, SlowAgingInterceptor adds one (4) and NegatingInterceptor negates.
    }
