...
public class UsingVetoToPreventInconsistentSpecializationTest {
    ...
    @Test
    public void testDeploymentSucceedsIfTheOtherSpecializingBeanIsVetoed() {
        assertTrue(foo instanceof Baz);
    }
}
