...
public class GenericBeanRawSpecialization01Test {

    @Deployment
    @ShouldThrowException(DefinitionException.class)
    public static Archive<?> createArchive() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(GenericBeanRawSpecialization01Test.class))
