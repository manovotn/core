...
public class FinalClassClassLevelInterceptorTest {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(FinalClassClassLevelInterceptorTest.class))
                .intercept(MissileInterceptor.class)
                .addPackage(FinalClassClassLevelInterceptorTest.class.getPackage());
    }
