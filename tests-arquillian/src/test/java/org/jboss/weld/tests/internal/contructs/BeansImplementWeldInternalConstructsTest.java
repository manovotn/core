...
public class BeansImplementWeldInternalConstructsTest {

    @Deployment
    public static Archive getDeployment() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(BeansImplementWeldInternalConstructsTest.class))
            .addPackage(BeansImplementWeldInternalConstructsTest.class.getPackage());
    }
    ...
    public void testClientProxyBean() {
        ...
        Object contextualInstance = wcp.getContextualInstance();
