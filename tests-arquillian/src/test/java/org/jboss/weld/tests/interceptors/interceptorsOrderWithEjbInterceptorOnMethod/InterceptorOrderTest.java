...
public class InterceptorOrderTest {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(InterceptorOrderTest.class))
                .intercept(CdiInterceptor2.class, CdiInterceptor.class)
    ...
    public void testOrder2(Processor processor) {
        ...
        Assertions.assertEquals(21, sum);
        Assertions.assertEquals(1, EjbInterceptor.count);
        Assertions.assertEquals(2, CdiInterceptor2.count);
        Assertions.assertEquals(3, CdiInterceptor.count);
        Assertions.assertEquals(4, SimpleProcessor.count);
    }
