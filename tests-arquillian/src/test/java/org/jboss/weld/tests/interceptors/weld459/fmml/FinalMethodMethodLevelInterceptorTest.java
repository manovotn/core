...
public class FinalMethodMethodLevelInterceptorTest {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(FinalMethodMethodLevelInterceptorTest.class))
                .intercept(MissileInterceptor.class)
                .addPackage(FinalMethodMethodLevelInterceptorTest.class.getPackage());
    }
