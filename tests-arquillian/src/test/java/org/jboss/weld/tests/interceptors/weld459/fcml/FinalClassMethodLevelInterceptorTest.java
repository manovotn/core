...
public class FinalClassMethodLevelInterceptorTest {
    ...
    public static Archive<?> deploy() {
        return ShrinkWrap.create(BeanArchive.class, Utils.getDeploymentNameAsHash(FinalClassMethodLevelInterceptorTest.class))
                .intercept(MissileInterceptor.class)
                .addPackage(FinalClassMethodLevelInterceptorTest.class.getPackage());
    }
