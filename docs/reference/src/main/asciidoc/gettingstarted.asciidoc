...
** GlassFish 4.0,
** Apache Tomcat 8 or better (war example only), or
...
you'll need to download Tomcat 8.5.33 or later from
...
[source, console]
------------------------------------
$> cd c:\path\to\apache-tomcat-8\bin
$> start
------------------------------------
