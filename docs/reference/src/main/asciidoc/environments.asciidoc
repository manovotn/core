...
Tomcat 8 and 9 are supported. Context activation/deactivation and dependency
...
However, if you’re using a Jetty standalone instance one more configuration step is required.
