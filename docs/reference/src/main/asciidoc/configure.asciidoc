...
By default and per CDI 1.2 specification, once there is an alternative defined in `beans.xml`, it cannot be vetoed in the code.
Setting this configuration key to `true` will bypass this rule and allow to veto such bean.

.Supported configuration properties
[cols=",,",options="header",]
|=======================================================================
|Configuration key |Default value |Description
|`org.jboss.weld.bootstrap.allowExcludedAlternatives` | false | If set to true, an alternative defined in beans.xml can be vetoed.
|=======================================================================
