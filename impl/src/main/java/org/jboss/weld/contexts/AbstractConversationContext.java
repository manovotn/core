...
import static org.jboss.weld.contexts.conversation.ConversationIdGenerator.CONVERSATION_ID_GENERATOR_ATTRIBUTE_NAME;
...
public abstract class AbstractConversationContext<R, S> extends AbstractBoundContext<R> implements ConversationContext {
    ...
    private void cleanUpConversationMap() {
        ...
        Iterator<Entry<String, ManagedConversation>> toClearIterator = conversations.entrySet().iterator();
